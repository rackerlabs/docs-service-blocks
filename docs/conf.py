# -*- coding: utf-8 -*-
"""
Professional Services Service Blocks Descriptions documentation build
configuration file.
...
#unused_docs = []
rst_epilog = """
.. |service| replace:: Professional Services - Service Blocks
.. |apiservice| replace:: <officialProjectName API>
.. |no changes| replace:: None for this release
.. |contract version| replace:: <version>
.. |product name| replace:: Professional Services - Service Blocks
"""
...
html_title = "Professional Services Service Block Descriptions"

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = "Service Block Descriptions"
